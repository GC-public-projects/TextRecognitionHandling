...
`\_uiStateTrigger ` & `uiStateTrigger` : stateFlow variable useful the trigger the recompositions of the UI when the elements of the drawscope (dataclasses stored in \_myBlocksList) are modified.
