...
//            val highlightColor = Color(1f, 0.5f, 0f, 0.5f) // Orange with 50% transparency
//
//            // Calculate scaling factors for the image relative to the view
...
//            val tempList: MutableList<MyBlock> = mutableListOf()
//
//            // Calculate adjusted positions for bounding boxes
//            for (block in visionText.textBlocks) {
//                block.boundingBox?.let { rect ->
...
//                    for (line in block.lines) {
//                        line.boundingBox?.let { rect ->
//                            val lineLeft = rect.left * scale + offsetX
//                            val lineTop = rect.top * scale + offsetY
//                            val lineRight = rect.right * scale + offsetX
//                            val lineBottom = rect.bottom * scale + offsetY
//                            val myLine = MyLine(
//                                line,
//                                highlightColor,
//                                lineLeft,
...
//                            for (element in line.elements) {
//                                element.boundingBox?.let { rect ->
//                                    val elementLeft = rect.left * scale + offsetX
//                                    val elementTop = rect.top * scale + offsetY
//                                    val elementRight = rect.right * scale + offsetX
//                                    val elementBottom = rect.bottom * scale + offsetY
...
//            val scale = minOf(scaleX, scaleY)
//
//            // Calculate offsets to center the image and apply movement
//            val offsetX = (viewWidth - imageWidth * scale) / 2 + moveX
//            val offsetY = (viewHeight - imageHeight * scale) / 2 + moveY
//
//            val tempList: MutableList<MyBlock> = mutableListOf()
//
//            // Adjust positions for blocks, lines, and elements
//            for (block in visionText.textBlocks) {
//                block.boundingBox?.let { rect ->
//                    val left = rect.left * scale + offsetX
//                    val top = rect.top * scale + offsetY
